# Comandos do `bdgd-light`

Referência completa da CLI. Para a visão geral do projeto e a demo em 5 minutos, veja o
[README](../README.md); o roteiro de aula está em [`demo-roteiro.md`](demo-roteiro.md).

Todo comando roda com `uv run bdgd-light <comando>`. `--help` em qualquer um lista as opções.
