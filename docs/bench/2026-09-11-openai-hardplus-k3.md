# Benchmark do agente — openai-hardplus-k3 (2026-09-11)
...
- commit: `eca5df2`; CSV: `docs/bench/2026-09-11-openai-hardplus-k3.csv`
...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| hard | 4 | 12 | 100 % | 100 % | 100 % | 68 % | 1,42 | 41.269 | 41.269 | 0.0172 | 0.0172 | 18.315 | 17,6 | 4,1 |
| total | 4 | 12 | 100 % | 100 % | 100 % | 68 % | 1,42 | 41.269 | 41.269 | 0.0172 | 0.0172 | 18.315 | 17,6 | 4,1 |
...
|---|---|---|---|---|---|---|---|---|---|---|---|
| H12 | hard | tijuca | 3/3 | 100 % | 100 % | 0,00 | locate_fault → isolate_fault → restore_options → propose_plan | 746851189, 23313112 | 23313112 | 27.360 | 18,0 |
| H13 | hard | tijuca | 3/3 | 100 % | 100 % | 1,33 | locate_fault → isolate_fault → restore_options → propose_plan → propose_plan | ∅ (sem chave) | — | 24.308 | 16,9 |
| H14 | hard | tijuca | 3/3 | 100 % | 100 % | 2,00 | locate_fault → isolate_fault → restore_options → propose_plan | 529355823 | 529355823 | 59.503 | 19,8 |
| H15 | hard | tijuca | 3/3 | 100 % | 100 % | 2,33 | locate_fault → isolate_fault → restore_options → propose_plan | ∅ (sem chave) | — | 53.904 | 15,7 |
